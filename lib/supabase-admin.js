  ...
  if (process.env.NEXT_PUBLIC_MOCK_DB === 'true') {
    return {
      from: (table) => {
        ...
        if (table === 'events') {
          return makeMockQuery([
            { id: 'mock-event-1', user_id: 'mock_user_12345', title: 'Health Checkup & Habit Reminder', description: 'Monthly wellness tracking', start_time: '2026-08-25T10:00:00.000Z', end_time: '2026-08-25T11:00:00.000Z', recurrence_rule: 'monthly', category: 'health', time_zone: 'Asia/Kolkata', created_at: new Date().toISOString() },
            { id: 'mock-event-2', user_id: 'mock_user_12345', title: 'Blood Donation Cycle', description: 'Regular donation interval', start_time: '2026-09-01T09:00:00.000Z', end_time: '2026-09-01T10:00:00.000Z', recurrence_rule: 'none', category: 'donation', time_zone: 'UTC', created_at: new Date().toISOString() }
          ], null);
        }
