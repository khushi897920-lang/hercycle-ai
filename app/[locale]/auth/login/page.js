  ...
  return (
    <main className={styles.page}>
      ...
      <div className={styles.sparkles} aria-hidden="true">
        <span className={styles.sparkle} style={{ top: '10%', left: '28%', animationDelay: '0s' }}></span>
        <span className={styles.sparkle} style={{ top: '22%', left: '42%', animationDelay: '1.8s' }}></span>
        <span className={styles.sparkle} style={{ top: '65%', left: '10%', animationDelay: '0.6s' }}></span>
        <span className={styles.sparkle} style={{ top: '82%', left: '30%', animationDelay: '3.2s' }}></span>
        <span className={styles.sparkle} style={{ top: '35%', left: '48%', animationDelay: '2.4s' }}></span>
      </div>
      ...
      <section className={styles.authSection} aria-label="Sign in">
            ...
            appearance={{
              elements: {
                ...
                headerSubtitle: {
                  fontSize: 0,
                  '&::after': {
                    content: '"Sign in to continue your wellness journey"',
                    fontSize: '0.875rem',
                  }
                },
