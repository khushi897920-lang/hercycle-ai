...
about: Trivial task or documentation fix for first-time contributors
title: '[GOOD FIRST ISSUE] '
labels: good first issue, beginner, ECSOC
assignees: ''
---

## 📌 Description
Provide a clear description of the small change requested.

## 🎯 Objective
What exactly needs to be modified or updated?

## ✅ Acceptance Criteria
- [ ] Visual or text changes are correct
